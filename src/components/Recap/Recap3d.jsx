...
const renderOrbitalObject = (object, index) => {
  switch (object.type) {
    case "Moon":
...
const useOrbitalAnimation = (orbitalObjects, setMoonPositions) => {
  useFrame(({ clock }) => {
    ...
    const orbitalPositions = calculateOrbitalPositions(orbitalObjects, time, rotationSpeed);
  ...
  return (
    <>
      <Suspense fallback={null}>
        <CentralEarth />
        <OrbitalBelt moonPositions={moonPositions} orbitalObjects={orbitalObjects} />
      </Suspense>
    </>
  );
}
